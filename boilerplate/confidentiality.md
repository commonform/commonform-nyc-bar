...
- to the extent consented to by the _Protected Party_,
- to the extent required by a discovery request in a court, arbitration or administrative proceeding; provided, that such party shall have first provided the _Protected Party_ with prompt written notice of such discovery request so that the _Protected Party_ may seek a protective order or other appropriate remedy, and in the event such protection or other remedy is not obtained, such party shall exercise commercially reasonable efforts to obtain assurance that confidential treatment will be accorded to such _Confidential Information_,
...
- to the extent necessary to enforce such party's rights under this _Agreement_.
